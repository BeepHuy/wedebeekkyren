...
class Smartlink extends CI_Controller { 
	...
	public function index(){//2001:ee0:46de:6090:7da6:fd02:e33f:8968
        ...
        if(!$smartlink->show){
         ...
         $mIdCat=explode('o',substr($smartlink->offercat,1,-1)); //magr ofer ca\t   
         $mIdCt=explode('o',substr($smartlink->country,1,-1)); //magr country id
        ...
        }elseif($smartlink->type==1){//cust9om*************************************    
