...
<?php
$ref= base_url('advertiser/signup/'.$this->session->userdata('advid'));
 echo '
<div clas="col-12 d-flex mt-5">
  <div class="sc-hMFtBS JjGPM mt-3" style="height:88px !important">
     <p class="sc-cLQEGU fdNgUv" >
     Referal link
     </p>
    <p>
    You will get a 3% increase on the total payment of the publisher you refer to work with Wedebeek.
    </p>
      <a href="'.$ref.'">
     '.$ref.'
      </a>
   ...
   <div class="_12e1_3IHEVbMTMaTUzZ7r9">
      <table role="table">
         <thead>
            ...
            <tr role="row">
                <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer;">Ref ID<span></span></th>

               <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer;">Offer ID<span></span></th>
               <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer;">Offer Title<span></span></th>
         ...
         <tbody role="rowgroup">
         <?php
         $thosts =$tpayed= $tclick = $tlead = $treve=$tdec=$tapp=0;
               ...
               echo '
                  <tr role="row" class="">
                    <td role="cell"><span class="_1zXei-ymiJr9KAeJboeM6O _2qzGcj9CQQHZm8SCJRN_wI"><span>'.$data->userid.'</span></span></td>
                     ...
                     <td role="cell"><span class="_1zXei-ymiJr9KAeJboeM6O _3ZpPE5ZwvUy6QGtl56rIQ6"><span>'.$data->oname.'</span></span></td>
                     ...
                     <td role="cell"><span class="_1zXei-ymiJr9KAeJboeM6O _2qzGcj9CQQHZm8SCJRN_wI"><span>$'.number_format(round($data->mpayed*0.3,2),2).'</span></span></td>
         ...
         <tfoot>
            ...
            <tr>
               ...
               <td colspan="1"><span class="_1zXei-ymiJr9KAeJboeM6O _2qzGcj9CQQHZm8SCJRN_wI"><span>$<?php echo number_format(round($tmpayed*0.3,2),2);?></span></span></td>
