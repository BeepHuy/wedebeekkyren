...
<div class="card mt-5">
   <div class="card-body" >
      <!--chart-->
      <span class="card-offers-stitle">SmartLinks</span>
      <form id="form_loc">
      ...
      <div class="border-top mt-3 pt-3 d-flex align-items-center justify-content-between">
         <div class="d-flex flex-column">
            ...
            <span><?php if(!empty($totals))echo $totals;else echo 0;?>&nbsp;Offers</span>
         </div>
         ...
         foreach($offer as $offer){
            ...
            if($offer->request&&$offer->status!='Approved'){
               if($offer->status=='Pending'){
                  $link = '<a href="'.base_url('/v2/smartlinks/offer_view/'.$offer->id).'" type="button" class="btn btn-warning btn-sm">Pending</a> ';
               }else{                  
                  $link = '<a href="'.base_url('/v2/smartlinks/offer_view/'.$offer->id).'" type="button" class="btn btn-primary btn-sm">Request Access</a> ';
               }
               
            }else{               
               $link = '<a href="'.base_url('/v2/smartlinks/offer_view/'.$offer->id).'" type="button" class="btn btn-outline-success btn-sm">Get Link</a>';
            }
            ...
            <div name="white" class="p-3 shadow bg-body border rounded d-flex box-offers-items">
               ...
               <div class="box-offers-container">
                  <div class="box-offers-detail">
                     ...
                     <a class="box-offers-links" href="'.base_url('/v2/smartlinks/offer_view/'.$offer->id).'">
                     '.$offer->title.'
                     </a>
