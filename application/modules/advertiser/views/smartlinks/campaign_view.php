      ...
      <div class="row campaign-views">
         <div class="col-lg-7 ps-md-3 pe-md-4 vcampaign_left">
            <div class="vcampaign_left_h d-flex flex-column">
               <div class="d-flex justify-content-between">
                  <div class="vcampaign_left_hl">
                     <p class="vcampaign_left_information">Smartlink information</p>
                     <div class="ljzHPa">
            ...
            <div class="vcampaign_left_h d-flex flex-column">
               <div class="row mt-3">
                  <div class="col-6">
                     <span><strong>Links preview:</strong></span><br>
                     <?php
               ...
               $t=0;              
                  if($offer->request){
                     if($status=='Pending'){
                        ...
                        echo '
                           <div class="mt-3">
                              <form class="form-rq" method="POST" action="'.base_url('v2/smartlinks/request/'.$offer->id).'">
