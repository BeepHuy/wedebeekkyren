                        ...
                        <div class="row d-flex justify-content-between my-sm-3">
                           <div class="d-flex col-md-8 col-sm-12 lign-items-start">                              
                              <div class="manager-avatar icon-square bg-light text-dark flex-shrink-0 me-3">
                                 <img src="<?php if(!empty($manager)) echo $manager->images;?>" alt="" wdith="100%">
                              </div>
                              ...
                              <div class="text-start">
                                 ...
                                 <div class="diem d-flex">
                                    ...
                                    <span class="ttusd align-self-center">USD
                                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="T_-OwGeVQ2tvt69C7mvbY css-4k7dfu"><polyline points="6 9 12 15 18 9"></polyline></svg>
                  ...
                  <div class=" db_info  p-4 d-flex flex-column card-daily-static">
                     ...
                     <div class="col row align-items-start flex-grow-1 staticdb"> 
                        ...
                        <div class="col-4 d-flex justify-content-center">                           
                           ...
                           <div>
                              <p class="card-daily-num"><?php if($dayli_static->click) echo $dayli_static->click;else echo 0;?></p>
                        ...
                        <div class="col-4 d-flex justify-content-center">                           
                           ...
                           <div>
                              <p class="card-daily-num"><?php if($dayli_static->hosts) echo $dayli_static->hosts;else echo 0 ;?></p>
                        ...
                        <div class="col-4 d-flex justify-content-center">                           
                           ...
                           <div>
                              <p class="card-daily-num"><?php if($dayli_static->lead) echo $dayli_static->lead;else echo 0;?></p>
                              ...
                              $p = '';
                                ...
                                <div class="card_noffer_item">
                                    ...
                                    <div class="card_noffer_content_wr">
                                        ...
                                        <div><a class="btn btn-outline-primary btn-sm" href="'.base_url('v2/offer/'.$newoffer->id).'">Details</a></div>
                                    </div>
                                    </div>
                                </div>
