            ...
            <div class="sc-Rmtcm cIUDWQ">
               <div class="sc-bRBYWo eVigII">
                  <div class="login-boximg">
                     <img
                        src=" <?php echo base_url() ?>/upload/files/website_logo_transparent_background.png"
                     ...
                     <form class="sc-kpOJdX kFPdwr" method="post" action="">
                        ...
                        <div data-test-id="login-signin-password-input" class="xzcRZ">
                           <div class="sc-kAzzGY jIpyka" height="52px">
                              ...
                              <input type="password" name="password" class="jxLAT click_btn_login" value="<?php if (set_value('password')) echo set_value('password'); ?>" id="ip_pass">
                           </div>
                        </div>
                        ...
                        <div class="login-submit">
                           ...
                           <a class="login_link1" href="<?php echo base_url('advertiser'); ?>">ADVERSTIER</a>

                        </div>
                        <div class="reset-submit">
                           <div class="reset-left">
                              <a class="reset_link" target="_blank" href="<?php echo base_url('v3/news/3'); ?>">Terms And Conditions</a>

                              <a class="reset_link" target="_blank" href="<?php echo base_url('v3/news/1'); ?>">Privacy Policy</a>
                           </div>
                           <div class="reset-right">
                              <a class="reset_link" href="<?php echo base_url('v3/sign/up'); ?>">Create Account</a>

                              <a class="reset_link" href="<?php echo base_url('v3/sign/password/reset'); ?>">Password Recovering</a>
                           </div>
                        </div>
                     </form>
                  </div>
   ...
   <script>
      $(document).ready(function() {
         $('.btn_signin').on('click', function(e) {
            ...
            ajurl = "<?php echo base_url('v3/sign/in'); ?>";
            $.ajax({
               type: "POST",
               url: ajurl,
               data: form.serialize(),
      ...
      function ajaxSuccess(data) {
         ...
         if (obj.error == 0) {
            setTimeout(() => {
               window.location.href = "<?php echo base_url('v3'); ?>";
            }, 2000);
         }
