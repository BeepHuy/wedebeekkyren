      ...
      <table role="table">
         <thead>
            <tr role="row">
               ...
               <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer;">Sale Amount<span></span></th>
         ...
         <?php
            if(!empty($data)){
               foreach($data as $data){
                  ...
                  <td class="align-middle text-center p-4">' . $data->saleAmount . ' USD </td>
                  <td role="cell">
