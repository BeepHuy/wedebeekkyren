...
<head>
    ...
    <title>Wedebeek Account Reactivation</title>
    <style>
        /* Reset styles */
        * {
            margin: 0;
    ...
    <div class="background">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>We are pleased to inform you that after our review, your account has been reactivated and is now available for use. You can log in to your dashboard and resume your activities immediately.</p>
                
                <a href="<?php echo base_url().'v2/sign/in';?>" class="btn-wedebeek">LOGIN NOW</a>
                
                <p>Thank you for your patience. We look forward to a mutually successful partnership.</p>
