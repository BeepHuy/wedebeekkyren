...
<head>
    ...
    <title>Wedebeek Email Approval</title>
    <style>
        /* Reset styles */
        * {
            margin: 0;
    ...
    <div class="background">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>🎉 We are pleased to inform you that your account has been approved following our review. You can now log in to your dashboard and start promoting our offers.</p>
                
                <a href="<?php echo base_url().'v2/sign/in';?>" class="btn-wedebeek">LOGIN NOW</a>
                
                <p style='margin:0'>Username: <strong><?php echo $email;?></strong></p>
                <p style='margin:0'>Password: <strong>Your password setting.</strong></p>
