...
<head>
    ...
    <title>Wedebeek Password Reset</title>
    <style>
        /* Reset styles */
        * {
            margin: 0;
    ...
    <div class="background">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>We have processed your password recovery request and have automatically reset your password for security purposes. Your updated login details are as follows:</p>
                ...
                <a href="<?php echo base_url().'v2/sign/in';?>" class="btn-wedebeek">LOGIN NOW</a>
                
                <p>For your protection, we recommend that you log in immediately and change your password to one of your choosing. If you did not request this change or have any concerns, please contact us at <strong>Support@wedebeek.com</strong> or reach out to your designated account manager.</p>
