...
<head>
    ...
    <title>Wedebeek Account Suspension</title>
    <style>
        /* Reset styles */
        * {
            margin: 0;
    ...
    <div class="background">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>Due to recent activity requiring further evaluation, your account has been temporarily suspended. This precautionary measure does not necessarily indicate permanent closure. Our team is reviewing the situation, and we will update you on whether your account can be reactivated.</p>
