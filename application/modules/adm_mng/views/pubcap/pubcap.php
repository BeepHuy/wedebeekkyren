<div class="row">
    <div class="box col-md-12">
        ...
        <div class="box-header">
            <h2><i class="glyphicon glyphicon-globe"></i><span class="break"></span>Cap Pub</h2>
            <div class="box-icon">
                <a class="btn-add" href="<?php echo base_url().$this->config->item('manager').'/'.$this->uri->segment(2).'/edit/0';?>"><i class="glyphicon glyphicon-plus"></i></a>
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php if(!empty($dulieu)){
                    ...
                    <tr>
                        ...
                        <td><?php echo $dulieu->usersid;?></td>
                        <td><?php echo $dulieu->sub2;?></td>
                        <td><?php echo $dulieu->capped;?></td>
                        <td><?php echo $dulieu->capcount;?></td>
                        <td><?php echo $dulieu->email;?></td>
                        <td><?php echo $dulieu->offername;?></td>
                        
                        <td>
                           
                            <!--edit>>>-->
                            <a href="<?php echo base_url().$this->config->item('manager').'/'.$this->uri->segment(2).'/edit/'.$dulieu->id;?>" class="btn btn-info btn-xs">
                            <i class="glyphicon glyphicon-edit glyphicon glyphicon-white"></i>                                            
                            </a>
                            <!--delete>>>-->
                            <a href="<?php echo base_url().$this->config->item('manager').'/'.$this->uri->segment(2).'/delete/'.$dulieu->id;?>" class="btn btn-danger btn-xs">
