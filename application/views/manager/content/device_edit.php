<div class="row">
    <div class="box col-md-12">
        <div class="box-header">
            <h2><i class="glyphicon glyphicon-globe"></i><span class="break"></span>Device</h2>
            <div class="box-icon">
        ...
        <form class="form-horizontal" method="POST" action="<?php echo base_url().$this->config->item('manager').'/route/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>">
         ...
         <?php if($dulieu){echo '<input class="hide" value="'.$dulieu->id.'" name="id"/>';} ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="title" name="device" value="<?php if($dulieu){echo $dulieu->device;} ?>" placeholder="Device"/>
            </div>
          </div>          
