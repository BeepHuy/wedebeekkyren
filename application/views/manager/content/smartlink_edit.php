                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-2">
                        ...
                        <select name="type" class="form-control stype">
                           ...
                           <option value="2" <?php if(!empty($dulieu)){echo $dulieu->type==2?' selected':'';} ?> >Redirect</option>                           
                        </select>
                     </div>
                   
                        <div class="col-md-2">
                           <label>Request</label>                    
                           <span class="box_switch<?php if($dulieu){echo $dulieu->request==1? '':' off';}else{ echo '';} ?>">
                           <a href="">switch off</a>
                           <input id="off_on" type='hidden' name="request" value="<?php if(!empty($dulieu->request)){echo $dulieu->request;}else{echo 1;}?>"/>
                           </span>
                        </div> 
                        <div class="col-md-2">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-2 clsh1">
                        ...
                        <div class="input-group"> 
                           ...
                           <input type="text" class="form-control" id="percent" name="percent" value="<?php if($dulieu){echo $dulieu->percent;}else echo 0;?>" placeholder="Percent"/>                          
                        </div>
                     </div>
                     ...
                     <div class="col-md-8 clsh1">
                        ...
                        <div class="input-group"> 
                           ...
                           <input type="text" class="form-control" id="url" name="url" value="<?php if($dulieu){echo $dulieu->url;}else echo '';?>" placeholder="..."/>                          
                        </div>
                     </div>
