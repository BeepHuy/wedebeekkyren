    ...
    <div class="box col-md-12">
        ...
        <div class="box-content">
            <div class="row">
                <div class="col-md-12">
                    <h4>
                        <b>Refferar: </b><?php echo base_url('v2/regmanager/'.$this->managerid);?></h4>
                ...
                <?php if(!empty($dulieu)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!--delete>>>-->
                            <a href="<?php echo base_url().$this->config->item('manager').'/route/users/delete/'.$dulieu->id;?>" class="btn btn-danger btn-xs del">
