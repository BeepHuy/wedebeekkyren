        ...
        <form class="form-horizontal" method="POST" action="<?php echo base_url().$this->config->item('manager').'/route/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>">
         ...
         <?php if($dulieu){echo '<input class="hide" value="'.$dulieu->id.'" name="id"/>';} ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="title" name="country" value="<?php if($dulieu){echo $dulieu->country;} ?>" placeholder="Country"/>
            </div>
          </div>          
          
          <div class="form-group">
            <label class="col-sm-2 control-label">Keycode</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="keycode" name="keycode" value="<?php if($dulieu){echo $dulieu->keycode;} ?>" placeholder="Country code"/>
            </div>
          </div>
