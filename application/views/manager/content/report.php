...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.13.2/themes/base/jquery-ui.min.css" integrity="sha512-ELV+xyi8IhEApPS/pSj66+Jiw+sOT1Mqkzlh8ExXihe4zfqbWkxPRi8wptXIO9g73FSlhmquFlUOuMSoXz5IRw==" crossorigin="anonymous" referrerpolicy="no-referrer" />	<script>
	$(function() {	   
        ...
        <div class="box-content">
            <div class="row">
               ...
               .inputrepr{margin-right: 50px;}
                ...
                <div class="col-md-12">
                    <!--
                    <a class="timkiem btn btn-danger" href="<?php echo base_url().$this->config->item('manager').'/export/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);?>" target="_blank">Export</a>
                  -->
                </div>  
                <div class="col-md-12">
