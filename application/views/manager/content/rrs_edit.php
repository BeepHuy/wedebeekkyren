        ...
        <form class="form-horizontal" method="POST" action="<?php echo base_url().$this->config->item('manager').'/route/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>">
         ...
         <?php if($dulieu){echo '<input class="hide" value="'.$dulieu->id.'" name="id"/>';} ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="title" name="title" value="<?php if($dulieu){echo $dulieu->title;} ?>" placeholder="Tiêu đề"/>
            </div>
          </div> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="notice" class="form-control" rows="3"><?php if($dulieu){echo $dulieu->notice;} ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="percent" class="form-control" rows="3"><?php if($dulieu){echo $dulieu->percent;} ?></textarea>
