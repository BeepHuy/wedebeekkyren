            ...
            <table class="table table-striped table-bordered">
                ...
                <?php if(!empty($dulieu)){
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo $dulieu->images;?>" width="50px" height="50px"/></td>
                        <td><?php echo $dulieu->name;?></td>
                        <td><?php echo $dulieu->username;?></td>
                        <td><?php echo $dulieu->email;?></td>
                        <td><?php echo $dulieu->phone;?></td>
                        <td><?php echo $dulieu->aim;?></td>
                        <td><?php echo $dulieu->skype;?></td>
