<div class="row">
    <div class="box col-md-12">
        <div class="box-header">
            <h2><i class="glyphicon glyphicon-globe"></i><span class="break"></span>Cap</h2>
            <div class="box-icon">
                <a class="btn-add" href="<?php echo base_url().$this->uri->segment(1).'/route/'.$this->uri->segment(3).'/list/';?>"><i class="glyphicon glyphicon-list-alt"></i></a>
        ...
        <!--- noi dung--->
        <form class="form-horizontal" method="POST" action="<?php echo base_url().$this->uri->segment(1).'/route/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="s2" name="s2" value="<?php if($dulieu){echo $dulieu->s2;} ?>" placeholder="Sub2"/>
            </div>
          </div>
          ...
          <input type="hidden" name="capcount" value="<?php if(!empty($dulieu->capcount)){echo $dulieu->capcount;}else echo 0?>"/>
