<div class="row">
    <div class="box col-md-12">
        <div class="box-header">
            <h2><i class="glyphicon glyphicon-globe"></i><span class="break"></span>Domain Referal Blacklist</h2>
            <div class="box-icon">
        ...
        <form class="form-horizontal" method="POST" action="<?php echo base_url().$this->config->item('admin').'/route/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="title" name="domain" value="<?php if($dulieu){echo $dulieu->domain;} ?>" placeholder="domain"/>
            </div>
          </div>          
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="reason" name="reason" value="<?php if($dulieu){echo $dulieu->reason;} ?>" placeholder="reason"/>
            </div>
          </div>
