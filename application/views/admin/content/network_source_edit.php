...
<div class="row">
    <div class="box col-md-12">
        <div class="box-header">
            <h2><i class="glyphicon glyphicon-inbox"></i><span class="break"></span>Network Source</h2>
            <div class="box-icon">
        ...
        <form class="form-horizontal" method="POST" action="<?php echo base_url().$this->config->item('admin').'/route/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>">
         ...
         <?php if($dulieu){echo '<input class="hide" value="'.$dulieu->id.'" name="id"/>';} ?>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="title" name="ns_name" value="<?php if($dulieu){echo $dulieu->ns_name;} ?>" placeholder="Name"/>
            </div>
          </div>          
          
          <div class="form-group">
            <label class="col-sm-2 control-label">Code CHeck</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="subid" name="ns_code" value="<?php if($dulieu){echo $dulieu->ns_code;} ?>" placeholder="Code Check"/>
            </div>
          </div>  
