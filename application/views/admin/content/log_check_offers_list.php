<div class="row">
    <div class="box col-md-12">
        <div class="box-header">
            <h2><i class="glyphicon glyphicon-inbox"></i><span class="break"></span>Log</h2>
            <div class="box-icon">
            ...
            <table class="table table-striped table-bordered">
                ...
                if(!empty($dulieu)){
                    ...
                    <tr>
                        ...
                        <td><?php echo $dulieu->logc_offerid;?></td>
                        <td><?php echo $dulieu->logc_status;?></td>
                        <td><?php echo $dulieu->logc_ssh;?></td>
                        <td><?php echo $dulieu->logc_date;?></td>
                        <td><?php echo $dulieu->logc_netsourceid;?></td>
                        <td>
